  ...
  return knex('jokes').truncate()
      .then(function () {
          return knex('jokes').insert([
              ...
              {joke: "What do you get from a papered cow?", punchline: "Spoiled milk"},
              {joke: "Why is it annoying to eat next to a basketball players", punchline: "The dribble all the time"},
